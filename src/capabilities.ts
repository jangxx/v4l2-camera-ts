import { V4L2_CAP_ASYNCIO, V4L2_CAP_AUDIO, V4L2_CAP_EXT_PIX_FORMAT, V4L2_CAP_HW_FREQ_SEEK, V4L2_CAP_META_CAPTURE, V4L2_CAP_MODULATOR, V4L2_CAP_RADIO, V4L2_CAP_RDS_CAPTURE, V4L2_CAP_RDS_OUTPUT, V4L2_CAP_READWRITE, V4L2_CAP_SDR_CAPTURE, V4L2_CAP_SDR_OUTPUT, V4L2_CAP_SLICED_VBI_CAPTURE, V4L2_CAP_SLICED_VBI_OUTPUT, V4L2_CAP_STREAMING, V4L2_CAP_TOUCH, V4L2_CAP_TUNER, V4L2_CAP_VBI_CAPTURE, V4L2_CAP_VBI_OUTPUT, V4L2_CAP_VIDEO_CAPTURE, V4L2_CAP_VIDEO_CAPTURE_MPLANE, V4L2_CAP_VIDEO_M2M, V4L2_CAP_VIDEO_M2M_MPLANE, V4L2_CAP_VIDEO_OUTPUT, V4L2_CAP_VIDEO_OUTPUT_MPLANE, V4L2_CAP_VIDEO_OUTPUT_OVERLAY, V4L2_CAP_VIDEO_OVERLAY } from "libv4l2-ts/dist/videodev2";
